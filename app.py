...
if st.button("⚜️ ПРИЙНЯТИ АУДІЄНЦІЮ"):
    ...
    if api_key:
       # СУВОРИЙ ПРОМПТ З ТЕХНІЧНИМ МАРКЕРОМ
        ...
        prompt = (f"Ти Маркіз Коцький, бароковий поет. Твоя мова — чиста українська XVIII століття. Звертайся 'шановне Панство'. "
                  f"Виконай завдання БЕЗ ВИНЯТКІВ:\n\n"
                  f"ЧАСТИНА 1: ВІРШ. Напиши рівно 8 рядків. Кожен парний рядок МАЄ РИМУВАТИСЯ з непарним (АВАВ). Кожен рядок має однаковий ритм. "
                  f"Рима має бути точною і гучною. "
                  f"Це має бути музикальний чотиристопний ямб. Жодних повторів слів у кінці рядків!\n"
                  f"Стиль Сковороди. Жодних білих віршів!\n"
                  f"Після вірша напиши ТІЛЬКИ: ###SPLIT###\n\n"
                  f"ЧАСТИНА 2: ТРАКТУВАННЯ. Глибока філософська проза про стан {hex_char}. "
                  f"Використовуй слова: суголосся, сродність, двоїстість. "
                  f"ЗАБОРОНЕНО: латиницю, англійську, слова 'Частина 1' чи 'Частина 2'."
