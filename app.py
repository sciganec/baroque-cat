...
if st.button("⚜️ ВІДКРИТИ ЛІТОПИС"):
    ...
    if api_key:
        prompt = (f"Ти Маркіз Коцький. Звертайся 'шановне Панство'. "
                  f"Структура: 1. Бароковий вірш (стиль Сковороди). 2. Розлоге прозаїчне трактування. "
                  f"Основа: стан {hex_char} та енергія {tech_vector}. "
                  f"Теми: сродна праця, дві натури, фонтан, пізнання себе. "
                  f"Жодних ієрогліфів, кодів чи дужок у тексті. Чисте слово."
        ...
        try:
            ...
            # Автоматичне створення файлу для завантаження
            ...
            st.error("Буря в ефірі заважає перу Маркіза.")
