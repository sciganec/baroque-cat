    ...
    if api_key:
       # СУВОРИЙ ПРОМПТ З ТЕХНІЧНИМ МАРКЕРОМ
        ...
        prompt = (f"Ти Маркіз Коцький, бароковий поет. Звертайся 'шановне Панство'. "
                  ...
                  f"ЧАСТИНА 1: РИМОВАНИЙ ВІРШ. Кожен рядок має чітку риму з іншим (наприклад: сад-виноград, тече-пече, душі-суші). "
                  f"Це не може бути білий вірш! Тільки дзвінка поезія. 8 рядків.\n"
                  f"###SPLIT###\n\n"
