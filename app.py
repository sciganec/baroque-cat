...
if st.button("⚜️ ПРИЙНЯТИ АУДІЄНЦІЮ"):
    ...
    if api_key:
       # СУВОРИЙ ПРОМПТ З ТЕХНІЧНИМ МАРКЕРОМ
        ...
        prompt = (f"Напиши відповідь суворо за схемою:\n"
                  f"1. РИМОВАНИЙ ВІРШ: 8 рядків. Схема ABAB. Рима має бути ОЧЕВИДНОЮ (наприклад: сад-зорепад, душі-суші). "
                  f"2. Рядок: ###SPLIT###\n"
                  f"3. ТРАКТУВАННЯ: Проза українською про гексаграму {hex_char}.\n\n"
                  f"Звертання: 'Шановне Панство'. Стиль: Сковорода. "
                  f"ЗАБОРОНА: Білий вірш, латиниця, повтори слів у римах.")
